        ...
        if(isset($_GET['id']) && isset($_GET['token']) && $_GET['time']){
            ...
            if($rowCount_check > 0){
                ...
                if($data_id != null){
                    ...
                    echo die('<div style="padding:20px;background-color:#3b3e79;color:#fff;font-size:14px;font-weight:600;font-family:monospace"class="rest_pass">Your Link Expaired Please rest Your Password Again</div>');
